...
class PittVirtualZoningBoardSpider(CityScrapersSpider):
    name = "pitt_virtual_zoning_board"
    agency = "City of Pittsburgh Virtual Zoning Board of Adjustments"
    timezone = "America/New_York"
    start_urls = ["https://pittsburghpa.gov/dcp/virtual-zba"]
    default_time = "9:00 AM"
    default_address = "200 Ross St., 3rd Floor, Pittsburgh, PA 15219"
